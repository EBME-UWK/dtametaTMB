...
#'
#' @param x Object of class \code{"CochraneSubgroup"} such as \code{"RutterGatsonisSubgroupLCA"}, \code{"ReitsmaSubgroupLCA"}
...
#' @export
forest.CochraneSubgroupLCA <- function(x, conflevel=0.95, subgroup_label="Subgroup", ...) {
