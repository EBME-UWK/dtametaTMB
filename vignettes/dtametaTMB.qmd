...
\quad \text{with} \quad \beta_1=-\log{(\mu_1}), \quad \lambda_1 = 1/\phi_1,$$
$$S_0(y) = \exp\left(-\exp\left(\frac{\log(y) - \beta_0}{\lambda_0}\right)\right),
...
$$S_1(y) = \left(1 +\exp\left(\frac{\log(y) - \beta_1}{\lambda_1}\right) \right)^{-1}, \quad \text{with} \quad \beta_1=-\phi^{-1}_1\log{(\mu_1}), \quad \lambda_1 = 1/\phi_1,$$
$$S_0(y) = \left(1 +\exp\left(\frac{\log(y) - \beta_0}{\lambda_0}\right) \right)^{-1}, \quad \text{with} \quad \beta_0=-\phi^{-1}_0\log{(\mu_0}), \quad \lambda_0 = 1/\phi_0.$$
